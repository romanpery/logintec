...
<head>
    <meta charset="UTF-8">
  	<title>Diseño material de inicio de sesión y Formulario de Registro</title>
...
<!-- ***************************Capa iniciar secion ************************-->
    <div class="col-lg-4 col-md-7 col-sm-6 col-xs-12 login-card" id="contenido0"<?php echo $c0;?>>

<!--Login (entrada) Formulario Página -->
    <form id="login-form" class="col-lg-12" method="POST" action="../controlador/logeo.php">
     ...
     <!-- fin de logo -->
        ...
        <!-- Iniciar Button -->
				...
				<button type="button" class="btn btn-lg btn-default btn-block giris-yap-buton" id="envia">Iniciar sesión</button>
					</div>
			<!-- #Iniciar botón Fin -->
        ...
        <div class="forgot-and-create tab-menu">
            ...
            <a class="hesap-olustur-link" href="index.php?ncapa=1">Crear cuenta.</a>
  ...
  <div class="col-lg-4 col-md-7 col-sm-6 col-xs-12 login-card" id="contenido1"<?php echo $c1;?>>
        ...
        <div class="group">
            ...
            <label><i class="material-icons input-sifre-ikon">lock</i><span class="span-input">Repetir contraseña</span></label>
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
				<!--     <input type="submit" class="btn btn-lg btn-success btn-block" value="Ingresar">-->
				<button type="button" class="btn btn-lg btn-default btn-block kayit-ol-buton" id="registrar">Registro</button>
					</div>
			<!-- #Iniciar botón Fin -->
        ...
        <a class="zaten-hesap-var-link" href="index.php?ncapa=0">¿Tiene una cuenta ya? , Entrar.</a>
...
<!-- ***************************Capa recuperacion de cuenta ************************-->
  <div class="col-lg-4 col-md-7 col-sm-6 col-xs-12 login-card" id="contenido2"<?php echo $c2;?>>
        ...
        <!-- Recuerde contraseña Botón -->
      	<div class="col-xs-12 col-sm-12 col-md-12">
				<button type="submit" class="btn btn-lg btn-default btn-block sifre-hatirlat-buton">Recordar contraseña</button>
					</div>

        <!-- #Contraseña Recordatorio botón Fin -->
